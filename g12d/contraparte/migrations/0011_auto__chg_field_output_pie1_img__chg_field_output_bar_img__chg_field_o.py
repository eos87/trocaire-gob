...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Output.pie1_img'
        db.alter_column('contraparte_output', 'pie1_img', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Output.bar_img'
        db.alter_column('contraparte_output', 'bar_img', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Output.pie2_img'
        db.alter_column('contraparte_output', 'pie2_img', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Output.pie1_img'
        db.alter_column('contraparte_output', 'pie1_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Output.bar_img'
        db.alter_column('contraparte_output', 'bar_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Output.pie2_img'
        db.alter_column('contraparte_output', 'pie2_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'trocaire.organizacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 16, 14, 47, 924842)'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
