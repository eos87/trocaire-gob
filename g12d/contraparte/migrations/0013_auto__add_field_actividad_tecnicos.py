...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actividad.tecnicos'
        db.add_column('contraparte_actividad', 'tecnicos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actividad.tecnicos'
        db.delete_column('contraparte_actividad', 'tecnicos')
    ...
    models = {
        ...
        'trocaire.organizacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 11, 32, 34, 970423)'}),
