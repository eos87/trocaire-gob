...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actividad.relevancia_m'
        db.add_column('contraparte_actividad', 'relevancia_m', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)

        # Adding field 'Actividad.efectividad_m'
        db.add_column('contraparte_actividad', 'efectividad_m', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)

        # Adding field 'Actividad.aprendizaje_m'
        db.add_column('contraparte_actividad', 'aprendizaje_m', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)

        # Adding field 'Actividad.empoderamiento_m'
        db.add_column('contraparte_actividad', 'empoderamiento_m', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)

        # Adding field 'Actividad.participacion_m'
        db.add_column('contraparte_actividad', 'participacion_m', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actividad.relevancia_m'
        db.delete_column('contraparte_actividad', 'relevancia_m')

        # Deleting field 'Actividad.efectividad_m'
        db.delete_column('contraparte_actividad', 'efectividad_m')

        # Deleting field 'Actividad.aprendizaje_m'
        db.delete_column('contraparte_actividad', 'aprendizaje_m')

        # Deleting field 'Actividad.empoderamiento_m'
        db.delete_column('contraparte_actividad', 'empoderamiento_m')

        # Deleting field 'Actividad.participacion_m'
        db.delete_column('contraparte_actividad', 'participacion_m')
    ...
    models = {
        ...
        'trocaire.organizacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 9, 52, 16, 579724)'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
