...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contraparte_actividad', 'ejes_transversales_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trocaire.EjeTransversal']))

        # Changing field 'Actividad.tipo_actividad'
        db.alter_column('contraparte_actividad', 'tipo_actividad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trocaire.TipoActividad']))

        # Changing field 'Actividad.tema_actividad'
        db.alter_column('contraparte_actividad', 'tema_actividad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trocaire.Tema']))
