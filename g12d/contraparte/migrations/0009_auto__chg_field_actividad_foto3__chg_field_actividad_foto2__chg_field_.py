...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Actividad.foto3'
        db.alter_column('contraparte_actividad', 'foto3', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Actividad.foto2'
        db.alter_column('contraparte_actividad', 'foto2', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Actividad.foto1'
        db.alter_column('contraparte_actividad', 'foto1', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'contraparte.actividad': {
            ...
            'foto1': ('thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'foto2': ('thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'foto3': ('thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
