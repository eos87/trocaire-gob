...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Output.time'
        db.alter_column('contraparte_output', 'time', self.gf('django.db.models.fields.TimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Output.time'
        raise RuntimeError("Cannot reverse this migration. 'Output.time' and its values cannot be restored.")
