...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Output.bar_img'
        db.add_column('contraparte_output', 'bar_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Output.pie1_img'
        db.add_column('contraparte_output', 'pie1_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Output.pie2_img'
        db.add_column('contraparte_output', 'pie2_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Actividad.foto3'
        db.alter_column('contraparte_actividad', 'foto3', self.gf('g12d.thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Actividad.foto2'
        db.alter_column('contraparte_actividad', 'foto2', self.gf('g12d.thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Actividad.foto1'
        db.alter_column('contraparte_actividad', 'foto1', self.gf('g12d.thumbs.ImageWithThumbsField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Output.bar_img'
        db.delete_column('contraparte_output', 'bar_img')

        # Deleting field 'Output.pie1_img'
        db.delete_column('contraparte_output', 'pie1_img')

        # Deleting field 'Output.pie2_img'
        db.delete_column('contraparte_output', 'pie2_img')

        # Changing field 'Actividad.foto3'
        db.alter_column('contraparte_actividad', 'foto3', self.gf('thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Actividad.foto2'
        db.alter_column('contraparte_actividad', 'foto2', self.gf('thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Actividad.foto1'
        db.alter_column('contraparte_actividad', 'foto1', self.gf('thumbs.ImageWithThumbsField')(max_length=100, null=True))
    ...
    models = {
        ...
        'contraparte.output': {
            ...
            'bar_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'file': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'params': ('django.db.models.fields.TextField', [], {}),
            'pie1_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'pie2_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
