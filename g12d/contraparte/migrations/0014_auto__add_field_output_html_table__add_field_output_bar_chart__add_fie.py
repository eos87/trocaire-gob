...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Output.html_table'
        db.add_column('contraparte_output', 'html_table', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Output.bar_chart'
        db.add_column('contraparte_output', 'bar_chart', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Output.pie_chart_one'
        db.add_column('contraparte_output', 'pie_chart_one', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Output.pie_chart_two'
        db.add_column('contraparte_output', 'pie_chart_two', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Output.html_table'
        db.delete_column('contraparte_output', 'html_table')

        # Deleting field 'Output.bar_chart'
        db.delete_column('contraparte_output', 'bar_chart')

        # Deleting field 'Output.pie_chart_one'
        db.delete_column('contraparte_output', 'pie_chart_one')

        # Deleting field 'Output.pie_chart_two'
        db.delete_column('contraparte_output', 'pie_chart_two')
    ...
    models = {
        ...
        'trocaire.organizacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 1, 11, 13, 22, 726914)'}),
