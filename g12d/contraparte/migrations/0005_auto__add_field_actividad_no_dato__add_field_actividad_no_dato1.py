...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actividad.no_dato'
        db.add_column('contraparte_actividad', 'no_dato', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Actividad.no_dato1'
        db.add_column('contraparte_actividad', 'no_dato1', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actividad.no_dato'
        db.delete_column('contraparte_actividad', 'no_dato')

        # Deleting field 'Actividad.no_dato1'
        db.delete_column('contraparte_actividad', 'no_dato1')
