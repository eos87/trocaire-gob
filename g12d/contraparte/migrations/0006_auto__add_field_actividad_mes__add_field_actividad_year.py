...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actividad.mes'
        db.add_column('contraparte_actividad', 'mes', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Actividad.year'
        db.add_column('contraparte_actividad', 'year', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actividad.mes'
        db.delete_column('contraparte_actividad', 'mes')

        # Deleting field 'Actividad.year'
        db.delete_column('contraparte_actividad', 'year')
