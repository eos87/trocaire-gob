...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.last_register'
        db.add_column('trocaire_organizacion', 'last_register', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 24, 9, 4, 5, 228104)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.last_register'
        db.delete_column('trocaire_organizacion', 'last_register')
    ...
    models = {
        ...
        'trocaire.organizacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 9, 4, 5, 228104)'}),
